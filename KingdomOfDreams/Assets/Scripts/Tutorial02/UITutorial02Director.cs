...
public class UITutorial02Director : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        EventManager.instance.onTutorial02ClearUI = () =>
        {
            StartCoroutine(this.map.CStageUIClear(2));
        };
    ...
    public void MissionInit()
    {
        ...
        {
            if (InfoManager.instance.DialogueInfo.id == 10011)
            {
                this.DialogueInit();
            }
            else
            {
                InfoManager.instance.DialogueInfo.id = 10012;
        ...
        {
            InfoManager.instance.DialogueInfo.id = 10014;
            InfoManager.instance.SaveDialogueInfo();
