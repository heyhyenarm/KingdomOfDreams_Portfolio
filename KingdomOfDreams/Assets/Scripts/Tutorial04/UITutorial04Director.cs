...
public class UITutorial04Director : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        EventManager.instance.onTutorial04ClearUI = () =>
        {
            StartCoroutine(this.map.CStageUIClear(4));
        };
    ...
    public void MissionInit()
    {
        ...
        {
            InfoManager.instance.DialogueInfo.id = 10028;
        ...
        {
            if (InfoManager.instance.DialogueInfo.id == 10029)
            {
                this.DialogueInit();
            }
            else
            {
                InfoManager.instance.DialogueInfo.id = 10030;
                InfoManager.instance.SaveDialogueInfo();
