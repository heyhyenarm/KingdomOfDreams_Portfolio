...
public class Tutorial04Main : MonoBehaviour
{
    //public PlayerMono playerMono;
    public UITutorial04Director director;
    ...
    public void Start()
    {
        //this.tutorialStage.clearGround(3);
        var tuto04_SC = SoundManager.GetSoundConnectionForThisLevel("Tutorial04");
        SoundManager.PlayConnection(tuto04_SC);
    }
    public void Init()
    {
        ...
        this.player.mono.transform.position = new Vector3(-14f, 0f, 8f);
    ...
    private void Update()
    {
        ...
        //if (this.npc.isClear && !this.isClearStage)
        {
            ...
            var stageInfo = InfoManager.instance.StageInfos.Find(x => x.stage == 4);
            if (stageInfo == null)
            {
                this.SaveClearInfos();
            }
    ...
    {
        InfoManager.instance.AddStageInfo(4);
    ...
    private void SubtractIngredientAmountN(NPC npc)
    {
        ...
        var fishInfo = InfoManager.instance.IngredientInfos.Find(x => x.id == 2003);
    ...
    private IEnumerator WaitForNPCReviveVideo(float time)
    {
        ...
        //볼륨 조절
        this.videoPlayerNPC.SetDirectAudioVolume(0, PlayerPrefs.GetFloat("SoundVolume"));
        ...
        this.GetReward(this.director.missionID);
        this.director.DialogueInit();
    ...
    private IEnumerator WaitForStageClearVideo(float time)
    {
        ...
        InfoManager.instance.DialogueInfo.id = 10033;
