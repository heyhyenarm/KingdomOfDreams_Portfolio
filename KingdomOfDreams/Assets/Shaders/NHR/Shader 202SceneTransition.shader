		...
		SubShader
		{
			...
			Pass
			{
				...
				half4 frag(VertOut i) : SV_Target
				{
					...
					//float3 black = (col.r + col.g + col.b) / 3;
					float4 black = (col.r + col.g + col.b) / 3;
					//half4 normal = tex2D(_BumpMap, )
					...
					if (dist > _ScanDistance) // Ых?ив
					{
						...
						if (edge.r > 0)
							return lerp(col, col, 1 - pow(_Threshold, 4));
						else
							return lerp(col, col, 1 - pow(_Threshold, 4));
					}
					return col;
